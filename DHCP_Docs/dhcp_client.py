...
class ClientDHCP(Client):
    ...
    def request(self, offer_packet):
        ...
        requested_addr = offer_packet[BOOTP].yiaddr
    ...
    def start_client(self) -> None:
        ...
        while True:
            try:
                sniff(filter='udp and port 67', prn=self.handle_offer)
